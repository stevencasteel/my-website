document.addEventListener('DOMContentLoaded', () => {
    ...
    const bookSalesCounter = document.getElementById('book-sales');
    const elfGirlSalesCounter = document.getElementById('elf-girl-sales');
    const goodreadsRatingsCounter = document.getElementById('goodreads-ratings');
    const goodreadsReviewsCounter = document.getElementById('goodreads-reviews');
    ...
    // Function to update sales and ratings counters
    function updateCounters() {
        // Simulating API calls or data fetching
        const bookSales = Math.floor(Math.random() * 100);
        const elfGirlSales = Math.floor(Math.random() * 50);
        const goodreadsRatings = Math.floor(Math.random() * 1000);
        const goodreadsReviews = Math.floor(Math.random() * 100);

        bookSalesCounter.textContent = bookSales;
        elfGirlSalesCounter.textContent = elfGirlSales;
        goodreadsRatingsCounter.textContent = goodreadsRatings;
        goodreadsReviewsCounter.textContent = goodreadsReviews;
    }

    // Update counters initially and then every 5 minutes
    updateCounters();
